    ...
    <div class="max-w-4xl mx-auto py-6 sm:py-12">
            ...
            <div class="p-8 sm:p-12 md:flex md:items-center md:space-x-8">
                ...
                <div class="md:w-2/3 space-y-6 text-center md:text-left">
                    ...
                    <p class="text-base sm:text-lg text-slate-600 leading-relaxed">
                        Selamat datang di <strong>PakarDemam v2.0</strong>. Sistem pakar diagnosis demam berbasis <em>Symptom-Driven Checklist & Scoring System</em> dengan penalti gejala berlebih untuk hasil diagnosis presisi, akurat, dan terpercaya.
                    </p>
                    <div class="pt-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 class="font-outfit font-bold text-slate-900 text-lg mb-2">Checklist Gejala</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
                    Pilih pola demam utama dan centang hingga maksimal 10 gejala penyerta yang Anda rasakan secara bebas.
                </p>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 class="font-outfit font-bold text-slate-900 text-lg mb-2">Scoring & Penalti</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
                    Sistem menghitung persentase kemiripan dan memotong skor sebesar 2% untuk setiap gejala tidak relevan yang dicentang.
                </p>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 class="font-outfit font-bold text-slate-900 text-lg mb-2">Hasil Diagnosa</h3>
                <p class="text-sm text-slate-500 leading-relaxed">
                    Dapatkan rekomendasi penanganan, persentase kemiripan, opsi cetak hasil, serta warning khusus medis.
                </p>
            </div>
        </div>
    </div>
